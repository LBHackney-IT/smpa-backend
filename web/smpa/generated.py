...
class InertLandfill:
    ...
    def __init__(self
            , totalVoidCapacity=None
            , maxAnnualOperationalThroughput=None
            ):
    ...
    maxAnnualOperationalThroughput = property(_get_maxAnnualOperationalThroughput, _set_maxAnnualOperationalThroughput)
    
    def as_dict(self):
        d = dict()
        if self.__totalVoidCapacity is not None:
            d['totalVoidCapacity'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__totalVoidCapacity]
        if self.__maxAnnualOperationalThroughput is not None:
            d['maxAnnualOperationalThroughput'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__maxAnnualOperationalThroughput]
        return d
...
class ConsentRegimes:
    ...
    def as_dict(self):
        ...
        if self.__consentRegime is not None:
            d['consentRegime'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__consentRegime]
        return d
...
class Boundaries:
    ...
    def as_dict(self):
        ...
        if self.__notApplicable is not None:
            d['notApplicable'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__notApplicable]
...
class WasteStorageCollection:
    ...
    def __init__(self
            , storeCollectWaste=None
            , storeCollectRecyclableWaste=None
            ):
    ...
    storeCollectRecyclableWaste = property(_get_storeCollectRecyclableWaste, _set_storeCollectRecyclableWaste)
    
    def as_dict(self):
        d = dict()
        if self.__storeCollectWaste is not None:
            d['storeCollectWaste'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__storeCollectWaste]
        if self.__storeCollectRecyclableWaste is not None:
            d['storeCollectRecyclableWaste'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__storeCollectRecyclableWaste]
        return d
...
class C1:
    ...
    def __init__(self
            ...
            , sat=None
            , sunBH=None
            , existingGrossFloorspace=None
            , grossFloorspaceToBeLost=None
            , totalGrossFloorspaceProposed=None
            , netAdditionalGrossFloorspace=None
    ...
    totalGrossFloorspaceProposed = property(_get_totalGrossFloorspaceProposed, _set_totalGrossFloorspaceProposed)
    ...
    netAdditionalGrossFloorspace = property(_get_netAdditionalGrossFloorspace, _set_netAdditionalGrossFloorspace)
    ...
    def as_dict(self):
        ...
        if self.__existingGrossFloorspace is not None:
            d['existingGrossFloorspace'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__existingGrossFloorspace]
        if self.__grossFloorspaceToBeLost is not None:
            d['grossFloorspaceToBeLost'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__grossFloorspaceToBeLost]
        if self.__totalGrossFloorspaceProposed is not None:
            d['totalGrossFloorspaceProposed'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__totalGrossFloorspaceProposed]
        if self.__netAdditionalGrossFloorspace is not None:
            d['netAdditionalGrossFloorspace'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__netAdditionalGrossFloorspace]
        if self.__roomInformation is not None:
            d['roomInformation'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__roomInformation]
        return d
...
class FileAttachment:
    ...
    def as_dict(self):
        ...
        if self.__printInformation is not None:
            d['printInformation'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__printInformation]
...
class NoticeRecipientPerson:
    ...
    def as_dict(self):
        ...
        if self.__personFamilyName is not None:
            d['personFamilyName'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__personFamilyName]
        return d
...
class NoticeRecipientAddress:
    ...
    def as_dict(self):
        ...
        if self.__streetDescription is not None:
            d['streetDescription'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__streetDescription]
...
class NonResidentialDevelopment:
    ...
    def as_dict(self):
        ...
        if self.__doesIncludeGainOrLoss is not None:
            d['doesIncludeGainOrLoss'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__doesIncludeGainOrLoss]
...
class DeclarationOfInterest:
    ...
    def as_dict(self):
        ...
        if self.__relationDetails is not None:
            d['relationDetails'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__relationDetails]
        return d
...
class Proposal:
    ...
    def __init__(self
            , schemaVersion=None
            , applicationHeader=None
            , fileAttachments=None
            , applicant=None
            , agent=None
            , siteLocation=None
            , applicationScenario=None
            , consentRegimes=None
    ...
    def as_dict(self):
        ...
        if self.__schemaVersion is not None:
            d['schemaVersion'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__schemaVersion]
        if self.__applicationHeader is not None:
            d['applicationHeader'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__applicationHeader]
        if self.__fileAttachments is not None:
            d['fileAttachments'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__fileAttachments]
        ...
        if self.__siteLocation is not None:
            d['siteLocation'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__siteLocation]
        if self.__applicationScenario is not None:
            d['applicationScenario'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__applicationScenario]
        if self.__consentRegimes is not None:
            d['consentRegimes'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__consentRegimes]
        if self.__applicationData is not None:
            d['applicationData'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__applicationData]
        if self.__declarationOfInterest is not None:
            d['declarationOfInterest'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__declarationOfInterest]
...
class FoulSewage:
    ...
    def as_dict(self):
        ...
        if self.__connectExistingDrainage is not None:
            d['connectExistingDrainage'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__connectExistingDrainage]
        if self.__supportingInformation is not None:
            d['supportingInformation'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__supportingInformation]
        return d
...
class Advertisement:
    ...
    def as_dict(self):
        ...
        if self.__publicationName is not None:
            d['publicationName'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__publicationName]
        return d
...
class OtherVehicle:
    ...
    def as_dict(self):
        ...
        if self.__vehicleTotals is not None:
            d['vehicleTotals'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__vehicleTotals]
        return d
...
class Payment:
    ...
    def as_dict(self):
        ...
        if self.__paymentMethod is not None:
            d['paymentMethod'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__paymentMethod]
...
class LastUse:
    ...
    def as_dict(self):
        ...
        if self.__lastUseDescription is not None:
            d['lastUseDescription'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__lastUseDescription]
        if self.__lastUseEndDate is not None:
            d['lastUseEndDate'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__lastUseEndDate]
        return d
...
class Email:
    ...
    def as_dict(self):
        ...
        if self.__emailAddress is not None:
            d['emailAddress'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__emailAddress]
        if self.__emailPreferred is not None:
            d['emailPreferred'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__emailPreferred]
...
class SupportingInformation:
    ...
    def as_dict(self):
        ...
        if self.__additionalInformation is not None:
            d['additionalInformation'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__additionalInformation]
        if self.__reference is not None:
            d['reference'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__reference]
        return d
...
class SiteLocation:
    ...
    def as_dict(self):
        ...
        if self.__bs7666Address is not None:
            d['bs7666Address'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__bs7666Address]
        if self.__siteGridRefence is not None:
            d['siteGridRefence'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__siteGridRefence]
        return d
...
class VisitContactDetails:
    ...
    def as_dict(self):
        ...
        if self.__contactOther is not None:
            d['contactOther'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__contactOther]
        if self.__contactAgent is not None:
            d['contactAgent'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__contactAgent]
        return d
...
class WasteManagementDetails:
    ...
    def __init__(self
            , inertLandfill=None
            , nonHazardousLandfill=None
            , hazardousLandfill=None
            , wasteIncinerationEnergy=None
            , otherIncineration=None
            , landfillGasGenerationPlant=None
            , pyrolysisGasification=None
            , metalRecyclingSite=None
            , transferStations=None
            , materialRecoveryFacilities=None
            , householdCivicAmenitySites=None
            , openWindrowComposting=None
            , invesselComposting=None
            , anaerobicDigestion=None
            , mbtTreatment=None
            , sewageTreatmentWorks=None
            , otherTreatment=None
            , recyclingFacilitiesCDEWaste=None
            , storageOfWaste=None
            , otherWasteManagement=None
            , otherDevelopments=None
            ):
    ...
    landfillGasGenerationPlant = property(_get_landfillGasGenerationPlant, _set_landfillGasGenerationPlant)
    ...
    materialRecoveryFacilities = property(_get_materialRecoveryFacilities, _set_materialRecoveryFacilities)
    ...
    householdCivicAmenitySites = property(_get_householdCivicAmenitySites, _set_householdCivicAmenitySites)
    ...
    recyclingFacilitiesCDEWaste = property(_get_recyclingFacilitiesCDEWaste, _set_recyclingFacilitiesCDEWaste)
    ...
    def as_dict(self):
        ...
        if self.__inertLandfill is not None:
            d['inertLandfill'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__inertLandfill]
        if self.__nonHazardousLandfill is not None:
            d['nonHazardousLandfill'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__nonHazardousLandfill]
        if self.__hazardousLandfill is not None:
            d['hazardousLandfill'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__hazardousLandfill]
        if self.__wasteIncinerationEnergy is not None:
            d['wasteIncinerationEnergy'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__wasteIncinerationEnergy]
        if self.__otherIncineration is not None:
            d['otherIncineration'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__otherIncineration]
        if self.__landfillGasGenerationPlant is not None:
            d['landfillGasGenerationPlant'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__landfillGasGenerationPlant]
        if self.__pyrolysisGasification is not None:
            d['pyrolysisGasification'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__pyrolysisGasification]
        if self.__metalRecyclingSite is not None:
            d['metalRecyclingSite'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__metalRecyclingSite]
        if self.__transferStations is not None:
            d['transferStations'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__transferStations]
        if self.__materialRecoveryFacilities is not None:
            d['materialRecoveryFacilities'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__materialRecoveryFacilities]
        if self.__householdCivicAmenitySites is not None:
            d['householdCivicAmenitySites'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__householdCivicAmenitySites]
        if self.__openWindrowComposting is not None:
            d['openWindrowComposting'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__openWindrowComposting]
        if self.__invesselComposting is not None:
            d['invesselComposting'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__invesselComposting]
        if self.__anaerobicDigestion is not None:
            d['anaerobicDigestion'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__anaerobicDigestion]
        if self.__mbtTreatment is not None:
            d['mbtTreatment'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__mbtTreatment]
        if self.__sewageTreatmentWorks is not None:
            d['sewageTreatmentWorks'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__sewageTreatmentWorks]
        if self.__otherTreatment is not None:
            d['otherTreatment'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__otherTreatment]
        if self.__recyclingFacilitiesCDEWaste is not None:
            d['recyclingFacilitiesCDEWaste'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__recyclingFacilitiesCDEWaste]
        if self.__storageOfWaste is not None:
            d['storageOfWaste'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__storageOfWaste]
        if self.__otherWasteManagement is not None:
            d['otherWasteManagement'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__otherWasteManagement]
        if self.__otherDevelopments is not None:
            d['otherDevelopments'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__otherDevelopments]
        return d
...
class Declaration:
    ...
    def as_dict(self):
        ...
        if self.__declarationDate is not None:
            d['declarationDate'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__declarationDate]
        if self.__declarationMade is not None:
            d['declarationMade'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__declarationMade]
        return d
...
class PaperSize:
    ...
    def as_dict(self):
        ...
        if self.__standardSize is not None:
            d['standardSize'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__standardSize]
        return d
...
class Disposal:
    ...
    def as_dict(self):
        ...
        if self.__specifiedOther is not None:
            d['specifiedOther'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__specifiedOther]
        return d
...
class FullTreesHedges:
    ...
    def __init__(self
            , treesHedgesOnSite=None
            , treesHedgesAdjacent=None
            ):
    ...
    def as_dict(self):
        ...
        if self.__treesHedgesOnSite is not None:
            d['treesHedgesOnSite'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__treesHedgesOnSite]
        if self.__treesHedgesAdjacent is not None:
            d['treesHedgesAdjacent'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__treesHedgesAdjacent]
        return d
...
class PrintInformation:
    ...
    def as_dict(self):
        ...
        if self.__hasBeenPrinted is not None:
            d['hasBeenPrinted'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__hasBeenPrinted]
...
class FloodRisk:
    ...
    def __init__(self
            , siteInFloodRiskArea=None
            , floodRiskTable=None
            , proposalNearWatercourse=None
            , proposalIncreaseFloodrisk=None
            , surfaceWaterDischarge=None
            ):
    ...
    proposalIncreaseFloodrisk = property(_get_proposalIncreaseFloodrisk, _set_proposalIncreaseFloodrisk)
    ...
    def as_dict(self):
        ...
        if self.__siteInFloodRiskArea is not None:
            d['siteInFloodRiskArea'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__siteInFloodRiskArea]
        if self.__floodRiskTable is not None:
            d['floodRiskTable'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__floodRiskTable]
        if self.__proposalNearWatercourse is not None:
            d['proposalNearWatercourse'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__proposalNearWatercourse]
        if self.__proposalIncreaseFloodrisk is not None:
            d['proposalIncreaseFloodrisk'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__proposalIncreaseFloodrisk]
        if self.__surfaceWaterDischarge is not None:
            d['surfaceWaterDischarge'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__surfaceWaterDischarge]
        return d
...
class Signatory:
    ...
    def as_dict(self):
        ...
        if self.__personNameTitle is not None:
            d['personNameTitle'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__personNameTitle]
        if self.__personGivenName is not None:
            d['personGivenName'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__personGivenName]
        if self.__personFamilyName is not None:
            d['personFamilyName'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__personFamilyName]
...
class NoticeGiven:
    ...
    def as_dict(self):
        ...
        if self.__noticeGivenTo is not None:
            d['noticeGivenTo'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__noticeGivenTo]
        return d
...
class RoomInformation:
    ...
    def __init__(self
            , existingRoomsToBeLost=None
            , totalRoomsProposed=None
            , netAdditionalRooms=None
            ):
    ...
    def as_dict(self):
        ...
        if self.__existingRoomsToBeLost is not None:
            d['existingRoomsToBeLost'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__existingRoomsToBeLost]
        if self.__totalRoomsProposed is not None:
            d['totalRoomsProposed'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__totalRoomsProposed]
        if self.__netAdditionalRooms is not None:
            d['netAdditionalRooms'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__netAdditionalRooms]
        return d
...
class Agent:
    ...
    def as_dict(self):
        ...
        if self.__externalAddress is not None:
            d['externalAddress'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__externalAddress]
        if self.__contactDetails is not None:
            d['contactDetails'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__contactDetails]
        return d
...
class ExistingUse:
    ...
    def __init__(self
            , currentUse=None
            , isCurrentlyVacant=None
            , lastUse=None
            , contaminatedLandKnown=None
            , contaminatedLandSuspect=None
            , contaminatedProposedUse=None
            , constructingNewBuilding=None
            ):
    ...
    def as_dict(self):
        ...
        if self.__isCurrentlyVacant is not None:
            d['isCurrentlyVacant'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__isCurrentlyVacant]
        ...
        if self.__contaminatedLandKnown is not None:
            d['contaminatedLandKnown'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__contaminatedLandKnown]
        if self.__contaminatedLandSuspect is not None:
            d['contaminatedLandSuspect'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__contaminatedLandSuspect]
        if self.__contaminatedProposedUse is not None:
            d['contaminatedProposedUse'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__contaminatedProposedUse]
        if self.__constructingNewBuilding is not None:
            d['constructingNewBuilding'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__constructingNewBuilding]
        return d
...
class InternationalAddress:
    ...
    def __init__(self
            , intAddressLine=None
            , countryOrInternationalPostCode=None
            ):
    ...
    countryOrInternationalPostCode = property(_get_countryOrInternationalPostCode, _set_countryOrInternationalPostCode)
    
    def as_dict(self):
        d = dict()
        if self.__intAddressLine is not None:
            d['intAddressLine'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__intAddressLine]
        if self.__countryOrInternationalPostCode is not None:
            d['countryOrInternationalPostCode'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__countryOrInternationalPostCode]
        return d
...
class TradeEffluent:
    ...
    def as_dict(self):
        ...
        if self.__disposeTradeWaste is not None:
            d['disposeTradeWaste'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__disposeTradeWaste]
        return d
...
class Access:
    ...
    def __init__(self
            , newAlteredVehicular=None
            , newAlteredPedestrian=None
            , newRightsOfWay=None
            , newPublicRoad=None
            , changeRightsOfWay=None
            ):
    ...
    def as_dict(self):
        ...
        if self.__newAlteredVehicular is not None:
            d['newAlteredVehicular'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__newAlteredVehicular]
        if self.__newAlteredPedestrian is not None:
            d['newAlteredPedestrian'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__newAlteredPedestrian]
        if self.__newRightsOfWay is not None:
            d['newRightsOfWay'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__newRightsOfWay]
        if self.__newPublicRoad is not None:
            d['newPublicRoad'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__newPublicRoad]
        if self.__changeRightsOfWay is not None:
            d['changeRightsOfWay'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__changeRightsOfWay]
        return d
...
class Materials:
    ...
    def as_dict(self):
        ...
        if self.__vehicleAccess is not None:
            d['vehicleAccess'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__vehicleAccess]
        ...
        if self.__externalWalls is not None:
            d['externalWalls'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__externalWalls]
        if self.__externalDoors is not None:
            d['externalDoors'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__externalDoors]
        if self.__other is not None:
            d['other'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__other]
        if self.__supportingInformation is not None:
            d['supportingInformation'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__supportingInformation]
...
class ApplicationData:
    ...
    def __init__(self
            , proposalDescription=None
            , siteArea=None
            , existingUse=None
            , residentialDevelopment=None
            , nonResidentialDevelopment=None
            , employment=None
            , hours=None
            , industrialCommercial=None
            ...
            , floodRisk=None
            , allTreesHedges=None
            , wasteStorageCollection=None
            , advice=None
            , siteVisit=None
            , ownershipCertificates=None
            , biodiversity=None
            ):
    ...
    nonResidentialDevelopment = property(_get_nonResidentialDevelopment, _set_nonResidentialDevelopment)
    ...
    def as_dict(self):
        ...
        if self.__proposalDescription is not None:
            d['proposalDescription'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__proposalDescription]
        ...
        if self.__residentialDevelopment is not None:
            d['residentialDevelopment'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__residentialDevelopment]
        if self.__nonResidentialDevelopment is not None:
            d['nonResidentialDevelopment'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__nonResidentialDevelopment]
        ...
        if self.__industrialCommercial is not None:
            d['industrialCommercial'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__industrialCommercial]
        if self.__hazardousSubstances is not None:
            d['hazardousSubstances'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__hazardousSubstances]
        if self.__tradeEffluent is not None:
            d['tradeEffluent'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__tradeEffluent]
        ...
        if self.__allTreesHedges is not None:
            d['allTreesHedges'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__allTreesHedges]
        if self.__wasteStorageCollection is not None:
            d['wasteStorageCollection'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__wasteStorageCollection]
        ...
        if self.__ownershipCertificates is not None:
            d['ownershipCertificates'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__ownershipCertificates]
        if self.__biodiversity is not None:
            d['biodiversity'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__biodiversity]
        return d
...
class ApplicationHeader:
    ...
    def __init__(self
            ...
            , dateSubmitted=None
            , refNum=None
            , formattedRefNum=None
            , applicationVersion=None
            , attachmentsChanged=None
            , description=None
            , payment=None
            , isValidApplication=None
            ):
    ...
    def as_dict(self):
        ...
        if self.__applicationTo is not None:
            d['applicationTo'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__applicationTo]
        if self.__dateSubmitted is not None:
            d['dateSubmitted'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__dateSubmitted]
        ...
        if self.__formattedRefNum is not None:
            d['formattedRefNum'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__formattedRefNum]
        if self.__applicationVersion is not None:
            d['applicationVersion'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__applicationVersion]
        if self.__attachmentsChanged is not None:
            d['attachmentsChanged'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__attachmentsChanged]
        ...
        if self.__isValidApplication is not None:
            d['isValidApplication'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__isValidApplication]
        return d
...
class OwnershipCertificates:
    ...
    def __init__(self
            , certificateSelected=None
            , noticeGiven=None
            , advertisement=None
            , ownershipDeclaration=None
            ):
    ...
    def as_dict(self):
        ...
        if self.__certificateSelected is not None:
            d['certificateSelected'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__certificateSelected]
        ...
        if self.__advertisement is not None:
            d['advertisement'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__advertisement]
        if self.__ownershipDeclaration is not None:
            d['ownershipDeclaration'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__ownershipDeclaration]
        return d
...
class Biodiversity:
    ...
    def __init__(self
            , protectedPrioritySpecies=None
            , designatedSites=None
            , geologicalConservationImportance=None
            ):
    ...
    protectedPrioritySpecies = property(_get_protectedPrioritySpecies, _set_protectedPrioritySpecies)
    ...
    geologicalConservationImportance = property(_get_geologicalConservationImportance, _set_geologicalConservationImportance)
    
    def as_dict(self):
        d = dict()
        if self.__protectedPrioritySpecies is not None:
            d['protectedPrioritySpecies'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__protectedPrioritySpecies]
        if self.__designatedSites is not None:
            d['designatedSites'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__designatedSites]
        if self.__geologicalConservationImportance is not None:
            d['geologicalConservationImportance'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__geologicalConservationImportance]
        return d
...
class SurfaceWaterDischarge:
    ...
    def __init__(self
            , sustainableDrainage=None
            , soakaway=None
            , mainSewer=None
            , existingWatercourse=None
            , pondLake=None
            ):
    ...
    def as_dict(self):
        ...
        if self.__sustainableDrainage is not None:
            d['sustainableDrainage'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__sustainableDrainage]
        ...
        if self.__existingWatercourse is not None:
            d['existingWatercourse'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__existingWatercourse]
...
class ExternalAddress:
    ...
    def as_dict(self):
        ...
        if self.__internationalAddress is not None:
            d['internationalAddress'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__internationalAddress]
        return d
...
class FileAttachments:
    ...
    def as_dict(self):
        ...
        if self.__fileAttachment is not None:
            d['fileAttachment'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__fileAttachment]
        return d
...
class Telephone:
    ...
    def as_dict(self):
        ...
        if self.__telNationalNumber is not None:
            d['telNationalNumber'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__telNationalNumber]
        ...
        if self.__telPreferred is not None:
            d['telPreferred'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__telPreferred]
...
class Substance:
    ...
    def as_dict(self):
        ...
        if self.__substanceName is not None:
            d['substanceName'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__substanceName]
        if self.__substanceQuantity is not None:
            d['substanceQuantity'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__substanceQuantity]
        return d
...
class SiteVisit:
    ...
    def as_dict(self):
        ...
        if self.__visitContactDetails is not None:
            d['visitContactDetails'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__visitContactDetails]
        return d
...
class ContactDetails:
    ...
    def as_dict(self):
        ...
        if self.__preferredContactMedium is not None:
            d['preferredContactMedium'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__preferredContactMedium]
        return d
...
class HazardousSubstances:
    ...
    def __init__(self
            , isUseStorageFollowingMaterials=None
            , substance=None
            ):
    ...
    isUseStorageFollowingMaterials = property(_get_isUseStorageFollowingMaterials, _set_isUseStorageFollowingMaterials)
    ...
    def as_dict(self):
        ...
        if self.__isUseStorageFollowingMaterials is not None:
            d['isUseStorageFollowingMaterials'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__isUseStorageFollowingMaterials]
...
class AllTreesHedges:
    ...
    def as_dict(self):
        ...
        if self.__fullTreesHedges is not None:
            d['fullTreesHedges'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__fullTreesHedges]
        return d
...
class FullParking:
    ...
    def as_dict(self):
        ...
        if self.__goodsVehicle is not None:
            d['goodsVehicle'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__goodsVehicle]
        ...
        if self.__otherVehicle is not None:
            d['otherVehicle'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__otherVehicle]
        return d
...
class NoticeGivenTo:
    ...
    def as_dict(self):
        ...
        if self.__noticeRecipient is not None:
            d['noticeRecipient'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__noticeRecipient]
        if self.__noticeGivenDate is not None:
            d['noticeGivenDate'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__noticeGivenDate]
        return d
...
class Fax:
    ...
    def as_dict(self):
        ...
        if self.__faxNationalNumber is not None:
            d['faxNationalNumber'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__faxNationalNumber]
        ...
        if self.__faxPreferred is not None:
            d['faxPreferred'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__faxPreferred]
...
class ProposalState:
    ...
    def __init__(self
            , proposalStarted=None
            , proposalCompleted=None
            ):
    ...
    def as_dict(self):
        ...
        if self.__proposalStarted is not None:
            d['proposalStarted'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__proposalStarted]
        if self.__proposalCompleted is not None:
            d['proposalCompleted'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__proposalCompleted]
        return d
...
class BS7666Address:
    ...
    def __init__(self
            ...
            , postTown=None
            , postCode=None
            , uniquePropertyReferenceNumber=None
            ):
        self.__paon = paon
        self.__streetDescription = streetDescription
        self.__locality = locality
    ...
    uniquePropertyReferenceNumber = property(_get_uniquePropertyReferenceNumber, _set_uniquePropertyReferenceNumber)
    ...
    def as_dict(self):
        ...
        if self.__uniquePropertyReferenceNumber is not None:
            d['uniquePropertyReferenceNumber'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__uniquePropertyReferenceNumber]
        return d
...
class IndustrialCommercial:
    ...
    def __init__(self
            , isProposalWasteManagementDevelopment=None
            , processesAndProducts=None
            , wasteManagementDetails=None
            , wasteStreamDetails=None
            ):
    ...
    isProposalWasteManagementDevelopment = property(_get_isProposalWasteManagementDevelopment, _set_isProposalWasteManagementDevelopment)
    ...
    def as_dict(self):
        ...
        if self.__isProposalWasteManagementDevelopment is not None:
            d['isProposalWasteManagementDevelopment'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__isProposalWasteManagementDevelopment]
        if self.__processesAndProducts is not None:
            d['processesAndProducts'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__processesAndProducts]
        if self.__wasteManagementDetails is not None:
            d['wasteManagementDetails'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__wasteManagementDetails]
        if self.__wasteStreamDetails is not None:
            d['wasteStreamDetails'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__wasteStreamDetails]
        return d
...
class Advice:
    ...
    def as_dict(self):
        ...
        if self.__haveSoughtAdvice is not None:
            d['haveSoughtAdvice'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__haveSoughtAdvice]
        if self.__adviceDetails is not None:
            d['adviceDetails'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__adviceDetails]
        return d
...
class ApplicationScenario:
    ...
    def as_dict(self):
        ...
        if self.__scenarioNumber is not None:
            d['scenarioNumber'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__scenarioNumber]
        return d
...
class ProposalDescription:
    ...
    def as_dict(self):
        ...
        if self.__descriptionText is not None:
            d['descriptionText'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__descriptionText]
        if self.__proposalState is not None:
            d['proposalState'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__proposalState]
        return d
...
class WasteStreamDetails:
    ...
    def __init__(self
            , municipal=None
            , constructionDemolitionExcavation=None
            , commercialIndustrial=None
            , hazardous=None
            ):
    ...
    constructionDemolitionExcavation = property(_get_constructionDemolitionExcavation, _set_constructionDemolitionExcavation)
    ...
    def as_dict(self):
        ...
        if self.__constructionDemolitionExcavation is not None:
            d['constructionDemolitionExcavation'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__constructionDemolitionExcavation]
        if self.__commercialIndustrial is not None:
            d['commercialIndustrial'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__commercialIndustrial]
...
class NoticeRecipient:
    ...
    def __init__(self
            , noticeRecipientPerson=None
            , noticeRecipientAddress=None
            ):
    ...
    def as_dict(self):
        ...
        if self.__noticeRecipientPerson is not None:
            d['noticeRecipientPerson'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__noticeRecipientPerson]
        if self.__noticeRecipientAddress is not None:
            d['noticeRecipientAddress'] = [p.as_dict() if hasattr(p, 'as_dict') else p for p in self.__noticeRecipientAddress]
        return d
